...
def connection_is_alive(client_tcp: socket_module.socket) -> bool:
    ...
    try:
        ...
        content = remote_server.execute(message_in_bytes)
...
tarefa_c = ArgParseSocketHomework(start_server_callback=start_tcp_server, start_client_callback=start_tcp_client,
                                  description='Desenvolver um Acesso remoto')
tarefa_c.parse()
